...
class MediaVideoView extends StatelessWidget {
  ...
  const MediaVideoView({Key? key, required this.imageMessages})
      : super(key: key);
    ...
    return Padding(
      ...
      child: GridView.builder(
          ...
          itemBuilder: (context, index) {
            if (imageMessages[index].type == "video") {
              return Material(
                        ...
                        Positioned(
                          ...
                          child: ClipRRect(
                            ...
                            child: FadeInImage.assetNetwork(
                                ...
                                fit: BoxFit.cover,
                                image: imageMessages[index].thumbnail),
                            // child: FadeInImage.assetNetwork(
                            //     placeholder: "assets/images/default.png",
                            //     image:),
                          ),
                          ...
                          child: Material(
                            ...
                            child: InkWell(
                              ...
                              onTap: () {
                                Get.to(
                                    VideoPlayerScreen(
                                      chatMessageModel: imageMessages[index],
                                    ),
